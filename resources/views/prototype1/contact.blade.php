                            ...
                            <div x-show="step === 3" style="display: none;" 
                                ...
                                <form @submit.prevent="submitBooking" class="space-y-4">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <input type="text" required class="custom-input w-full rounded-xl py-3 px-4 outline-none text-sm font-medium" placeholder="First Name">
                                        </div>
                                        <div>
                                            <input type="text" required class="custom-input w-full rounded-xl py-3 px-4 outline-none text-sm font-medium" placeholder="Last Name">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <input type="email" required class="custom-input w-full rounded-xl py-3 px-4 outline-none text-sm font-medium" placeholder="Email Address">
                                        </div>
                                        <div>
                                            <input type="text" class="custom-input w-full rounded-xl py-3 px-4 outline-none text-sm font-medium" placeholder="Company (Optional)">
                                        </div>
                                    </div>
                                    <div>
                                        <textarea rows="2" class="custom-input w-full rounded-xl py-3 px-4 outline-none text-sm font-medium resize-none" placeholder="Briefly describe what you'd like to discuss..."></textarea>
                                    </div>
