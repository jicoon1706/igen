            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="{{ route('portfolio') }}" class="text-gray-400 hover:text-white hover:translate-x-2 inline-block transition-all duration-300 group">
                                <span class="group-hover:border-b-2 group-hover:border-purple-500">Portfolio</span>
                            </a>
                        </li>
                        <li>
