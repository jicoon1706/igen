        ...
        <section id="contact" class="py-24 px-4 sm:px-6 lg:px-8 gradient-bg relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto text-center relative z-10">
                ...
                <a href="{{ route('contact') }}" 
                    ...
                    Start Your Project <span class="inline-block ml-2">🚀</span>
                </a>
                ...
                <div class="mt-16 grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
                    ...
                    <div class="glass rounded-2xl p-6">
                        <div class="text-purple-200 mb-2">Location</div>
                        <div class="text-white font-semibold">Batu Caves, Selangor</div>
                    </div>
                    <!-- <div class="glass rounded-2xl p-6">
