...
@section('content')
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="svc-row mb-32" data-aos="fade-up">
                ...
                <div class="svc-content">
                    ...
                    <a href="{{ route('contact') }}" class="svc-cta">
                        Get Started
    ...
    <section class="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10 px-4" data-aos="fade-up">
            ...
            <a href="{{ route('contact') }}" class="bg-purple-600 text-white px-10 py-4 rounded-full font-bold hover:bg-purple-500 transition-all shadow-lg inline-flex items-center group">
                Start Your Journey
